...
// Default season configuration hash (should match CLAUDE.md)
const DEFAULT_SEASON_CONFIG_HASH = 'default_season_hash_2024'
...
export async function fetchLeaderboardData(): Promise<LeaderboardData> {
  ...
  const currentSeasonConfigHash = process.env.NEXT_PUBLIC_CURRENT_SEASON_CONFIG_HASH || DEFAULT_SEASON_CONFIG_HASH
